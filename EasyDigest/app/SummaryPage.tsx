...
export default function SummaryPage() {
  ...
  const [summaryHeight, setSummaryHeight] = useState(0); // ✅ articleBox 높이 저장
  ...
  return (
    <View style={styles.container}>
      <View
        ...
        onLayout={(e) => setSummaryHeight(e.nativeEvent.layout.height)} // ✅ summary 높이 측정
      >
        {/* 위쪽 border */}
        ...
        >
          {wordList.map((word, idx) => (
            <View style={styles.termItem} key={idx}>
              ...
              <DefaultText style={styles.termDesc}>
                {word.description}
              </DefaultText>
            </View>
          ))}
